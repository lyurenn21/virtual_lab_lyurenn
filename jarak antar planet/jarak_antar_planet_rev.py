...
# Fungsi untuk menggambar orbit planet secara statis
def plot_orbits():
    ...
    for i, (planet, distance) in enumerate(planets.items()):
        # Membuat orbit planet dalam bentuk lingkaran
        ...
        # Gambar planet pada orbitnya
        ax.plot(x[0], y[0], 'o', label=planet)

    # Menambahkan label dan pengaturan tampilan
    ax.set_title("Orbit Planet dalam Tata Surya")
